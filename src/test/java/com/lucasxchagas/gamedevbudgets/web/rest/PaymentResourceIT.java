...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().paymentType(DEFAULT_PAYMENT_TYPE);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().paymentType(UPDATED_PAYMENT_TYPE);
        return payment;
    }
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.paymentType(UPDATED_PAYMENT_TYPE);
