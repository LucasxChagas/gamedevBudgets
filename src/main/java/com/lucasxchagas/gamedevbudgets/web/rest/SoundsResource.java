...
public class SoundsResource {
     ...
     */
    @GetMapping("/sounds")
    public ResponseEntity<List<SoundsDTO>> getAllSounds(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Sounds");
        Page<SoundsDTO> page = soundsService.findAll(pageable);
